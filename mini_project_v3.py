    ...
    def solve(self, param):
        ...
        if solver.is_sat():
            ...
            for teacher_index in range(len(self.index_teacher_list)):
                ...
                total_teacher_hours = []
                for week in range(len(self.planning_lectures.col)):
                    hours = get_teacher_hours(teacher_index, self.index_teacher_list, week, Solution(self.planning_lectures),
                                              Solution(self.planning_tutorials), Solution(self.planning_experiments))
