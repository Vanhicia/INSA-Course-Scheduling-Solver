...
def data_set(n):
    ...
    if n == 1:
        ...
        course_list = [course_1, course_2, course_3, course_4, course_5,
                       ...
                       course_14
                       # ,course_15
                        , course_16, course_17, course_18,
                       course_19, course_20, course_21, course_22
                       ]
        ...
        group_4 = {'name': '4IR-SC', 'course_list': [course_1, course_2, course_3, course_4, course_5,
                                                     # course_6, course_7, course_8, course_9,
                                                     course_16, course_17,
                                                     course_18, course_19, course_20,course_21,course_22], 'promo': "2"}
        group_list = [group_1, group_2, group_3, group_4]

        # Promo #
        promo_1_SI = [group_1, group_2, group_3]
        promo_1_SC = [group_4]
        # promo_2 = [group_3, group_4]
        promo_list = group_functions.get_promos(group_list)
        promo_list2 = [promo_1_SI, promo_1_SC]

        # Teachers #
        teacher_1 = {'name': "Nicolas Van Wambeke", 'course_list': [
            {'course': course_1, 'lecture_promo': [promo_1_SI, promo_1_SC], 'tutorial_gp': [group_1], 'experiment_gp': []}]}
        teacher_2 = {'name': "Sami Yangui", 'course_list': [
            {'course': course_2, 'lecture_promo': [promo_1_SI, promo_1_SC], 'tutorial_gp': [group_1, group_2, group_3, group_4],
             'experiment_gp': [group_1, group_2]}]}
        teacher_3 = {'name': "Christophe Chassot", 'course_list': [
            {'course': course_3, 'lecture_promo': [promo_1_SI, promo_1_SC], 'tutorial_gp': [group_1, group_2, group_3, group_4],
             'experiment_gp': [group_1, group_2]}]}
        teacher_4 = {'name': "Francois Vernadat", 'course_list': [
            {'course': course_4, 'lecture_promo': [promo_1_SI, promo_1_SC], 'tutorial_gp': [], 'experiment_gp': []}]}
        teacher_5 = {'name': "Vincent Nicomette", 'course_list': [
            {'course': course_5, 'lecture_promo': [promo_1_SI, promo_1_SC], 'tutorial_gp': [], 'experiment_gp': []}]}
        ...
        teacher_11 = {'name': "Didier Le Botlan", 'course_list': [
            {'course': course_10, 'lecture_promo': [promo_1_SI], 'tutorial_gp': promo_1_SI, 'experiment_gp': []}]}
        teacher_12 = {'name': "Yannick Pencolé", 'course_list': [
            {'course': course_11, 'lecture_promo': [promo_1_SI], 'tutorial_gp': promo_1_SI, 'experiment_gp': []}]}
        teacher_13 = {'name': "Mohamed Siala", 'course_list': [
            {'course': course_12, 'lecture_promo': [promo_1_SI], 'tutorial_gp': promo_1_SI, 'experiment_gp': []}]}
        teacher_14 = {'name': "Laurent Dairaine", 'course_list': [
            {'course': course_13, 'lecture_promo': [promo_1_SI], 'tutorial_gp': [], 'experiment_gp': []}]}
        teacher_15 = {'name': "Nawal Guermouche", 'course_list': [
            {'course': course_14, 'lecture_promo': [promo_1_SI], 'tutorial_gp': [], 'experiment_gp': []}]}
        # teacher_16 = {'name': "Vincent Mahout", 'course_list': [
        #     {'course': course_15, 'lecture_promo': [promo_1_SI], 'tutorial_gp': promo_1_SI, 'experiment_gp': []}]}

        teacher_17 = {'name': "Slim Abdelatif", 'course_list': [
            {'course': course_16, 'lecture_promo': [promo_1_SC], 'tutorial_gp': promo_1_SC,
             'experiment_gp': promo_1_SC},
        ...
        teacher_18 = {'name': "Daniela Dragomirescu", 'course_list': [
            {'course': course_17, 'lecture_promo': [promo_1_SC], 'tutorial_gp': promo_1_SC,
             'experiment_gp': promo_1_SC}]}
        teacher_19 = {'name': "Anne Nicolas", 'course_list': [
            {'course': course_18, 'lecture_promo': [promo_1_SC], 'tutorial_gp': [], 'experiment_gp': promo_1_SC}]}
        teacher_20 = {'name': "Jean-Louis Noullet", 'course_list': [
            {'course': course_19, 'lecture_promo': [promo_1_SC], 'tutorial_gp': [], 'experiment_gp': promo_1_SC}]}

        teacher_21 = {'name': "Alexandre Boyer", 'course_list': [
            {'course': course_20, 'lecture_promo': [promo_1_SC], 'tutorial_gp': promo_1_SC, 'experiment_gp': []},
            {'course': course_22, 'lecture_promo': [promo_1_SC], 'tutorial_gp': promo_1_SC,
             'experiment_gp': promo_1_SC}]}
        ...
        teacher_24 = {'name': "Eric Alata", 'course_list': [
            {'course': course_5, 'lecture_promo': [], 'tutorial_gp': [group_1, group_2, group_3, group_4],
             'experiment_gp': [group_1, group_2, group_3, group_4]}]}

        teacher_assistant_1 = {'name': "Doctorant 1", 'course_list': [
            {'course': course_10, 'lecture_promo': [], 'tutorial_gp': [], 'experiment_gp': promo_1_SI},
            {'course': course_11, 'lecture_promo': [], 'tutorial_gp': [], 'experiment_gp': promo_1_SI}
        ]}
        teacher_assistant_2 = {'name': "Doctorant 2", 'course_list': [
            {'course': course_1, 'lecture_promo': [], 'tutorial_gp': [group_4], 'experiment_gp': []},
            {'course': course_14, 'lecture_promo': [], 'tutorial_gp': promo_1_SI, 'experiment_gp': []}]}
        ...
        teacher_list = [teacher_1, teacher_2, teacher_3, teacher_4, teacher_5,
                        ...
                        teacher_11, teacher_12, teacher_13, teacher_14,
                        teacher_15,
                        # teacher_16,
                        teacher_17, teacher_18, teacher_19, teacher_20, teacher_21,
                        teacher_22, teacher_24,
                        teacher_assistant_1,
                        teacher_assistant_2,
                        # teacher_assistant_3, teacher_assistant_4
                        ]
        ...
        return course_list, teacher_list, group_list, promo_list, promo_list2, rooms_list, value_type_room, teacher_absence_list, spe_cst_list
