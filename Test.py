...
def data_set(n):
    ...
    if n == 1:
        ...
        course_2 = {'name': 'Computer Science', 'lecture': 30, 'tutorial': 10, 'experiment': 15, 'type_room': value_type_room[4]}
        course_3 = {'name': 'Security', 'lecture': 10, 'tutorial': 0, 'experiment': 0, 'type_room': value_type_room[3]}
        ...
        group_3 = {'name': "4IR-C", 'course_list': [course_4, course_5], 'promo': "2"}
