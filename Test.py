...
def data_set(n):
    ...
    if n == 1:
        ...
        group_4 = {'name': "4IR-D", 'course_list': [course_1, course_5], 'promo': "2"}
        group_list = [group_1, group_2, group_3, group_4]

        # Teachers #
        teacher_1 = {'name': "Michel Dumont", 'course_list': [
                         {'course': course_1, 'lecture_gp_nb': 1, 'tutorial_gp_nb': 0, 'experiment_gp_nb': 4},
                         {'course': course_2, 'lecture_gp_nb': 0, 'tutorial_gp_nb': 1, 'experiment_gp_nb': 0}]}
        ...
        teacher_4 = {'name': "Kate Stuart", 'course_list': [
                         {'course': course_3, 'lecture_gp_nb': 1, 'tutorial_gp_nb': 0, 'experiment_gp_nb': 1}]}
